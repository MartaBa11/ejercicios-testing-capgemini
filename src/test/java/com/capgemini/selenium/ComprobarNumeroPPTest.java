...
public class ComprobarNumeroPPTest {
  ...
  @Test
  public void comprobarNumeroPP() {
    // Test name: ComprobarNumeroPP
    // Step # | name | target | value
    // 1 | open | /pactometro/ | 
    driver.get("https://cursosdedesarrollo.com/pactometro/");
    // 2 | setWindowSize | 666x680 | 
    driver.manage().window().setSize(new Dimension(666, 680));
    // 3 | assertText | css=#part-PP > h2 | 89
    assertEquals("89",driver.findElement(By.cssSelector("#part-PP > h2")).getText());
